package com.woorifisa.won_card_channel_server.domain.user.exception.handler;
...
@Slf4j
@RestControllerAdvice(basePackages = "com.woorifisa.won_card_channel_server.domain.user.api")

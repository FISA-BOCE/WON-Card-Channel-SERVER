    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/cards/auto-invest/subscriptions/*").authenticated()
                        .requestMatchers(HttpMethod.PATCH, "/api/cards/auto-invest/subscriptions/*").authenticated()

    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/auth/signup", "/api/auth/login", "/api/auth/refresh", "/internal/cards/sweep-requests","/internal/cards/sweep-requests/auto", "/internal/card/db/mysql/query").permitAll()
